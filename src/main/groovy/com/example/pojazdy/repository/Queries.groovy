...
//        AND SP.PARTNER_UUID = :PARTNER_UUID"""
    ...
    static final String SELECT_DOCUMENT_ID = """SELECT MAX(D.ID) FROM SYSADM.DOCUMENTS D WHERE D.PARTNER_UUID = :PARTNER_UUID AND D.TYPE_CODE = :TYPE_CODE
        AND D.FILENAME = :FILENAME AND D.DESCRIPTION = :DESCRIPTION"""
}
