...
abstract class Queries {
    ...
    static final String AVAILABLE_CARS_FOR_SERVICE_PLAN = """SELECT C.* FROM SYSADM.CARS C WHERE C.SERVICE_PLAN_ID IS NULL AND C.PARTNER_UUID = :PARTNER_UUID"""
...
//        AND SP.PARTNER_UUID = :PARTNER_UUID"""
    ...
    static final String SELECT_SERVICE_PLANS_EVENTS_FOR_PARTNER = """SELECT SE.*  FROM SYSADM.CARS C, SYSADM.SERVICE_PLAN SP, SYSADM.SERVICE_EVENTS SE 
        WHERE C.SERVICE_PLAN_ID = SP.ID AND SP.ID = SE.PLAN_ID AND C.CAR_ID = :CAR_ID 
            AND SE.NOTIFICATION_MILEAGE <= 
                (SELECT MAX(CE.MILEAGE) FROM SYSADM.CAR_EVENTS CE WHERE CE.CAR_ID = :CAR_ID)"""
    ...
    static final String INSERT_INTO_SERVICE_EVENTS = """INSERT INTO SYSADM.SERVICE_EVENTS (PLAN_ID, MILEAGE, PERIOD, COMMENTS, NOTIFICATION_MILEAGE, NOTIFICATION_PERIOD)
        VALUES(:PLAN_ID, :MILEAGE, :PERIOD, :COMMENTS, :NOTIFICATION_MILEAGE, :NOTIFICATION_PERIOD)"""
    ...
    static final String DELETE_SERVICE_EVENT = """DELETE FROM SYSADM.SERVICE_EVENTS WHERE PLAN_ID = :PLAN_ID AND ORDER_NO = :ORDER_NO"""
    ...
    static final String SELECT_CAR_EVENTS_FOR_PARTNER_CAR = """SELECT CE.*, ET.NAME, D.FIRST_NAME, D.LAST_NAME, D.DRIVER_UUID 
    ...
    static final String INSERT_INTO_DOCUMENTS = """INSERT INTO SYSADM.DOCUMENTS (PARTNER_UUID, TYPE_CODE, DRIVER_UUID, FILENAME, DESCRIPTION, SYSTEM_ENTRY_DATE) 
        VALUES(:PARTNER_UUID, :TYPE_CODE, :DRIVER_UUID, :FILENAME, :DESCRIPTION, :SYSTEM_ENTRY_DATE)"""

    static final String INSERT_INTO_DOCUMENT_FILE_TYPES = """INSERT INTO SYSADM.DOCUMENT_FILE_TYPES (PARTNER_UUID, CODE) VALUES(:PARTNER_UUID, :CODE)"""

    static final String INSERT_INTO_CAR_EVENTS_DOCUMENTS = """INSERT INTO SYSADM.CAR_EVENTS_DOCUMENTS (EVENT_ID, DOCUMENT_ID) VALUES(:EVENT_ID, :FILE_ID)"""

    static final String SELECT_PARTNER_DOCUMENTS = """SELECT D.* FROM SYSADM.DOCUMENTS D WHERE D.PARTNER_UUID = :PARTNER_UUID"""

    static final String SELECT_DOCUMENT_BY_ID = """SELECT D.* FROM SYSADM.DOCUMENTS D WHERE D.PARTNER_UUID = :PARTNER_UUID AND D.ID = :DOCUMENT_ID"""

    static final String SELECT_DOCUMENT_ID = """SELECT MAX(D.ID) FROM SYSADM.DOCUMENTS D WHERE D.PARTNER_UUID = :PARTNER_UUID AND D.FILENAME = :FILENAME"""

    // Invoices

    static final String INSERT_INTO_INVOICES = """INSERT INTO SYSADM.INVOICE_IMAGES_DATA (INVOICE_IMAGE_UUID, PARTNER_UUID, DRIVER_UUID, LINK_ID, 
        FILENAME, DESCRIPTION, SYSTEM_ENTRY_DATE, DELETED_BY_DRIVER_TIMESTAMP) VALUES (:UUID, :PARTNER_UUID, :DRIVER_UUID, 1,
         :FILENAME, :DESCRIPTION, :SYSTEM_ENTRY_DATE, NULL)"""

    static final String INSERT_INTO_CAR_EVENTS_INVOICES = """INSERT INTO SYSADM.CAR_EVENTS_INVOICES (EVENT_ID, INVOICE_IMAGE_UUID) VALUES(:EVENT_ID, :INVOICE_UUID)"""

    static final String SELECT_PARTNER_INVOICES = """SELECT IID.* FROM SYSADM.INVOICE_IMAGES_DATA IID WHERE IID.PARTNER_UUID = :PARTNER_UUID"""

    static final String SELECT_INVOICE_BY_UUID = """SELECT IID.* FROM SYSADM.INVOICE_IMAGES_DATA IID WHERE IID.PARTNER_UUID = :PARTNER_UUID AND IID.INVOICE_IMAGE_UUID = :UUID"""
}
